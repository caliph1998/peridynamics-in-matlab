...
for i = 1:NumofDiv_x
    for j = 1:NumofDiv_y
      ...
      if (left_tip.inEllipse(coordx, coordy) || right_tip.inEllipse(coordx, coordy))
          continue
          %nullpoint(nnum,1) = 0;
      end
...
%testNode = 555;
testCoordinates = [-0.05, -0.01];
testNode = get_closest_point(testCoordinates(1,1), testCoordinates(1,2), coord, center_hole, left_tip, right_tip, nnum);
